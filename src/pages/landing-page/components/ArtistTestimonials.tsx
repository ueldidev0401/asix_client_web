...
const artists = [
  {
    ...
    quote:
      'As an artist, I spend much of my time seeing around the corner to the future of the industry, and Asix+ is clearly the way forward. I’m thrilled to join this team.',
