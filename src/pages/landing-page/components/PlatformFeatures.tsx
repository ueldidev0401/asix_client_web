...
const messages = {
  title: (isMobile: boolean) =>
    isMobile ? 'Designed for Artists' : 'Asix+ Listens to Artists',
  subTitle:
...
const features: Array<FeatureProps> = [
  {
    title: 'HQ AUDIO',
    description:
      'Asix+ offers crystal clear streaming at 320kbps! The highest quality sound from any free music platform.',
